...
import macbookpro16 from "../data/macbookpro16"
import "../Mac/Macbookpro16.css"
...
function Macbookpro16() {
    ...
    return (
        <div>
            ...
            {macbookpro16.map((index, key) =>
                <div key={key} className="item1">
                    <div className="image88">
                        <img className="macimg" id={index.model} src={index.color[0].src} alt="" />
                    </div>
